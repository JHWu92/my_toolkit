...
class MyFastMarkerCluster(MarkerCluster):
    """
    ...
    # TODO: improve callback, params, etc to add popups and change colors
    def __init__(self, data, attrs=None, callback=None,
                 name=None, overlay=True, control=True, show=True):
        super(MyFastMarkerCluster, self).__init__(name=name, overlay=overlay,
                                                control=control)
        self._name = 'MyFastMarkerCluster'
